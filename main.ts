...
function CreateLevel () {
    ...
    if (level == 1) {
        ...
        for (let index = 0; index < 4; index++) {
            Wall_Shooter_DOWN = sprites.create(img`
...
let Scene_1_Cambita_Bien = sprites.create(img`
    . . . . . f f 4 4 f f . . . . . 
    . . . . f 5 4 5 5 4 5 f . . . . 
    . . . f e 4 5 5 5 5 4 e f . . . 
...
story.spriteMoveToLocation(Scene_1_Cambita_Bien, 89, 60, 20)
let Scene_1_Corazon = sprites.create(img`
    . . . . . . . . . . . . . . . . 
    . . f f f f f f . f f f f f f . 
...
pause(2000)
let Scene_1_Auto = sprites.create(img`
    . . . . . . . e e e e e . . . . 
    . . . . . e e 2 2 2 2 2 e . . . 
    . . . . e e 2 2 2 2 2 2 2 e . . 
...
let Scene_1_Papa_Bien = sprites.create(img`
    . . . . f f f f . . . . 
    . . f f e e e e f f . . 
    . f f e e e e e e f f . 
